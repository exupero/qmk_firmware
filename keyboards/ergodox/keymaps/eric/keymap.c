...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_NO,         KC_QUOT, KC_COMM,KC_DOT,  KC_P,   KC_Y,   LALT(LSFT(KC_UP)),
        ALL_T(KC_NO),   KC_A,    KC_O,   KC_E,    KC_U,   KC_I,
        KC_NO,        KC_SCLN, KC_Q,   KC_J,    KC_K,   KC_X,   LALT(LSFT(KC_DOWN)),
        TG(MDIA),       KC_LCTL, KC_LALT,  KC_LGUI,   KC_ESC,
                                                            LGUI(KC_C),  LGUI(KC_V),
                                                                      LGUI(LALT(KC_I)),
                                                 KC_LSFT,KC_TAB,LGUI(KC_R),
        // right hand
        LGUI(KC_LEFT),    KC_CIRC,   KC_AMPR,   KC_ASTR,   KC_NO,   KC_NO, LGUI(KC_RGHT),
...
[NUMB] = KEYMAP(
       ...
       KC_TRNS, KC_TRNS, LSFT(KC_SLSH), KC_PIPE,KC_SLSH,   KC_BSLS,    KC_TRNS,
                         KC_TRNS,   KC_TRNS,  KC_TRNS,    KC_TRNS,  KC_TRNS,
       KC_TRNS, KC_TRNS,
       KC_TRNS,
       KC_TRNS, KC_TRNS, KC_TRNS
...
[MDIA] = KEYMAP(
       ...
       KC_TRNS, KC_TRNS, KC_TRNS, KC_MS_U, KC_TRNS, KC_VOLU, KC_TRNS,
